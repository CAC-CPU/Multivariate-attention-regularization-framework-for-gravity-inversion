function inversion = trandition_reweight_conjugate_gradient_V2(inversion,A)
...
reweightBegin = inversion.reweightIndex(1);
...
for n = 1:CN
    ...
    if (n > 2 && n < reweightBegin) || (n >= reweightBegin && mod(n,reweightGap) == 0)
